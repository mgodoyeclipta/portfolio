...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    // Toggle DOM class only — next-themes sync happens after transition
    const applyTheme = () => {
    ...
    if (typeof document.startViewTransition !== "function") {
      applyTheme()
      if (isControlled) onThemeChange?.(newTheme)
      return
    }
    ...
    // Sync next-themes AFTER animation completes to avoid conflicting transitions
    if (isControlled) {
      const onDone = () => onThemeChange?.(newTheme)
